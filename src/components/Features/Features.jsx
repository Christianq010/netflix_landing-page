...
import cancelTab from './Cancel/cancelContent';
        ...
        return (
            <Features>
                <div className="featureNav">
                    ...
                    <a onClick={this.toggleContent.bind(this)}>
                        <svg className="selected" viewBox="0 0 40 48" width="60px" height="49px" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            <g>
                    ...
                    <a onClick={this.toggleWatch.bind(this)}>
                        <svg viewBox="0 0 145 48" width="140px" height="49px"  version="1.1" xmlns="http://www.w3.org/2000/svg">
                            <g>
                    ...
                    <a onClick={this.togglePrice.bind(this)}>
                        <svg viewBox="0 0 63 48" width="60px" height="49px" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            <g>
